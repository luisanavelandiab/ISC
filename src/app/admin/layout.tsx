...
.mob-topbar {
  ...
  padding: 0 18px; height: 56px; background: var(--black-mid);
...
.mob-toggle span { display:block; width:18px; height:1.5px; background:var(--white-dim); transition:all .3s ease; transform-origin:center; }
...
.sidebar {
  width:240px; min-width:240px; background:var(--black-mid); border-right:1px solid var(--border);
...
.sidebar-brand { margin-bottom:32px; padding-bottom:22px; border-bottom:1px solid var(--border); }
.sidebar-label { font-size:9px; font-weight:600; letter-spacing:4px; text-transform:uppercase; color:var(--gold); margin-bottom:6px; }
.sidebar-title { font-family:'Cormorant Garamond',serif; font-size:26px; font-weight:300; color:var(--white); letter-spacing:-.5px; line-height:1.1; }
.sidebar-title span { color:var(--gold); font-style:italic; font-weight:600; }
.sidebar-ornament { display:flex; align-items:center; gap:8px; margin-top:8px; }
...
.nav-section-label { font-size:8px; letter-spacing:3px; text-transform:uppercase; color:rgba(201,168,76,.4); margin-bottom:8px; margin-top:4px; padding-left:12px; }
.nav-link {
  display:flex; align-items:center; gap:12px; padding:12px 14px;
  color:var(--white-dim); text-decoration:none; font-size:12px; font-weight:400; letter-spacing:1px;
...
.logout-btn {
  width:100%; padding:11px 14px; background:transparent; border:1px solid rgba(229,115,115,.25);
  color:rgba(229,115,115,.7); font-family:'Montserrat',sans-serif; font-size:11px; font-weight:500;
...
.mob-bottom-nav { display:flex; position:fixed; bottom:0; left:0; right:0; background:var(--black-mid); border-top:1px solid var(--border); z-index:200; }
.mob-bottom-nav::before {
  content:''; position:absolute; inset:0;
  background-image:linear-gradient(45deg,rgba(201,168,76,.02) 1px,transparent 1px),linear-gradient(-45deg,rgba(201,168,76,.02) 1px,transparent 1px);
  background-size:30px 30px; pointer-events:none;
}
.mob-nav-item { flex:1; display:flex; flex-direction:column; align-items:center; justify-content:center; gap:3px; padding:8px 4px 10px; color:var(--white-dim); text-decoration:none; font-size:9px; font-weight:500; letter-spacing:1px; text-transform:uppercase; transition:color .2s; position:relative; }
.mob-nav-item.active { color:var(--gold); }
.mob-nav-item.active::before { content:''; position:absolute; top:0; left:10%; right:10%; height:2px; background:linear-gradient(90deg,transparent,var(--gold),transparent); }
